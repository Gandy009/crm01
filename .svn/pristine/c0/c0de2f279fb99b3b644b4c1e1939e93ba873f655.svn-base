...
public class ContactHandler {
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="/deleteAjax/{id}/{customerId}", method=RequestMethod.DELETE)
	public String deleteAjax(@PathVariable("id") Integer id,
			@PathVariable("customerId") Integer customerId,
			RedirectAttributes attributes){
		int num=contactService.getContactNumByCustomerId(customerId);
