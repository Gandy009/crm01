...
<body class="main">
	...
	<div class="button_bar">
		...
		<form:form action="${ctp }/plan/savePlan" method="post" modelAttribute="salesPlan">
		...
		<table class="data_list_table" border="0" cellPadding="3"
			...
			<c:if test="${not empty salesPlances }">
				<c:forEach items="${salesPlances }" var="plan">
					<tr id="plan-${plan.id}">
