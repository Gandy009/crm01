...
<body class="main">
	...
	<form:form method="put" action="${ctp}/customer/updateCustomer"  modelAttribute="customer" id="hiddenForm">
		<form:hidden path="id"/>
		<table class="query_form_table" border="0" cellPadding="3"
			...
			<tr>
				...
				<td>
					...
					<c:if test="${!empty managers }">
						<form:options path="managers.id" items="${managers }" itemLabel="name" itemValue="id" />
					</c:if>
					</form:select>
					<span class="red_star">*</span>
				</td>
